// код: добавить оценку для 2 четверти
...
but_add.addEventListener('click', async ()=>{
    ...
    const res = await fetch("/quarter_2_db_add", {       
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          id_student: list_students.value, // выбранный ученик
          id_subject: list_subjects.value, // выбранный предмет
